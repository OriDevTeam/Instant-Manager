...
settingsFilePath="../../shared/settings/${settingsFolderPath}/description/${settingsType}.txt"
...
echo $(bash get_folder_setting_description.sh "${settingsFilePath}" "$configurationToken")